...
/**
 * Created by Ibrahim on 6/20/2016.
 */public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>  {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            int i = getPosition();
            if (i == 1) {
                Intent intent = new Intent(contxt, triplist.class);
                contxt.startActivity(intent);
            }
            if (i == 2) {
                Intent intent = new Intent(contxt, profile.class);
                contxt.startActivity(intent);
            }
            if (i == 3) {
                Intent intent = new Intent(contxt, CreateTrip.class);
                contxt.startActivity(intent);
            }
            if (i == 4) {
                Intent intent = new Intent(contxt, contactus.class);
                contxt.startActivity(intent);
            }
            if (i == 5) {
